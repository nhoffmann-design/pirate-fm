...
const INTROS = {
  ...
  station_id_short: [
    "Frequency's live.",
    "Still tuned in. Still loud.",
    "No ads. No apologies.",
    "Broadcasting from the static.",
    "You found the frequency. Don't waste it.",
    "Keep it low. Keep it moving.",
    "Transmission holds.",
    "If you can hear this, it's working.",
    "Stay tuned.",
    "Radio's not dead. It's hiding.",
  ],
  station_id_medium: [
    "Reality's noisy. We're louder.",
    "The world talks. We transmit.",
    "Still broadcasting. Still intact. Keep the frequency alive.",
    "No feed. No scroll. Just signal.",
    "Retro transmissions from the future. Don't blink.",
    "If the dial feels wrong, that's the point.",
    "Broadcast continues. Permission denied.",
    "We don't chase trends. We steal frequencies.",
  ],
  station_id_edgy: [
    "Still broadcasting. Still irritating someone important.",
    "Still live. Still illegal-ish. Still beautiful.",
    "The rules are expensive. The signal is free.",
    "Broadcasting responsibly, which is to say, not at all.",
    "Compliance is a myth.",
    "Still defiant. Still unsponsored.",
  ],
  station_id_frequency_alive: [
    "You know the drill. Keep the frequency alive.",
    "Frequency's breathing. Keep it alive.",
    "Transmission stable. Frequency alive.",
  ],
};
